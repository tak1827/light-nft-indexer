...
// RegisterHolderHandlerServer registers the http handlers for service Holder to "mux".
// UnaryRPC     :call HolderServer directly.
...
// RegisterHolderHandlerFromEndpoint is same as RegisterHolderHandler but
...
func RegisterHolderHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterHolderHandler(ctx, mux, conn)
}

// RegisterHolderHandler registers the http handlers for service Holder to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterHolderHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterHolderHandlerClient(ctx, mux, NewHolderClient(conn))
}

// RegisterHolderHandlerClient registers the http handlers for service Holder
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "HolderClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "HolderClient"
